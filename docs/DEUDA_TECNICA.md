...
| DB-001 | Alta | Supabase | CERRADO | Hardening de funciones y cobertura de índices FK. | 42 migraciones al día; Advisors seguridad sin lints; 27 índices FK presentes; tablas de asignación sin acceso API directo. |
