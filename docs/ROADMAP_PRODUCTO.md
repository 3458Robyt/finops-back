...
> El corte vigente es `npm run test:unit`: 95 archivos aprobados, 4 omitidos, 377 pruebas pasadas y 10 omitidas; IA offline 24/24. AWS real, OCI Usage API, rate limiting distribuido, secret manager externo y operación 24/7 siguen
