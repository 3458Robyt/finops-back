...
- El backend puede ejecutar responsabilidades de operación de forma granular
  ...
  `notification-scheduler` y `auth-cleanup-scheduler`. Los alias `worker`,
