...
- Verificación vigente: backend `test:all` con 85 archivos, 336 pruebas pasadas y 9 omitidas; escenarios IA
...
- Backend: `npm run test:all` (85 archivos aprobados, 336 pruebas pasadas y 9 omitidas),
