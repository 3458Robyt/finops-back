...
export function mapCloudConnection(
  ...
  return {
    ...
    ...(connection.lastValidationAttemptAt !== null ? { lastValidationAttemptAt: connection.lastValidationAttemptAt } : {}),
...
export function toIngestionJobHistoryItem(
  ...
  return {
    ...
    projectionAttempts: job.projectionAttempts,
    projectionMaxAttempts: job.projectionMaxAttempts,
    ...(job.projectionAvailableAt !== null ? { projectionAvailableAt: job.projectionAvailableAt } : {}),
    ...(job.projectionStartedAt !== null ? { projectionStartedAt: job.projectionStartedAt } : {}),
    ...(job.projectionCompletedAt !== null ? { projectionCompletedAt: job.projectionCompletedAt } : {}),
    ...(job.projectionErrorMessage !== null ? { projectionErrorMessage: job.projectionErrorMessage } : {}),
    ...
    ...(job.cancelRequestedAt !== null ? { cancelRequestedAt: job.cancelRequestedAt } : {}),
    ...(job.archivedAt !== null ? { archivedAt: job.archivedAt } : {}),
