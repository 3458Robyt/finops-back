...
- Activar `DB_RUNTIME_ENFORCE=true` mediante canary y completar pruebas de aislamiento por tenant
  con la base principal; las migraciones RLS y el rol runtime ya están aplicados en Supabase.
