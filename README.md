...
La verificación local recomendada es `npm run test:all`: el corte vigente cubre 104 archivos aprobados,
4 omitidos, 433 pruebas pasadas y 10 omitidas, además de typecheck, arquitectura, escenarios IA offline
