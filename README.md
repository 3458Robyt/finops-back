...
La verificación local recomendada es `npm run test:all`: el corte vigente cubre 105 archivos aprobados,
4 omitidos, 436 pruebas pasadas y 10 omitidas, además de typecheck, arquitectura, escenarios IA offline
